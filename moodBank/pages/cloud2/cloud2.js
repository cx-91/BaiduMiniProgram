...
Page({
  ...
  selectWord: function (e) {
    console.log(this.data);
    var tagEle = this.data.tagEle; // wordInfo.magicSentence[e.currentTarget.dataset.index].selected = !wordInfo.magicSentence[e.currentTarget.dataset.index].selected;
    ...
    wordInfo.sentenceMeaning = "且随疾风前行"; //查询单词等待回调
